<%@ Page Title="" Language="C#" MasterPageFile="~/finalwebpvc/Agent_Master.master" AutoEventWireup="true" CodeFile="Customer_Payment_Report.aspx.cs" Inherits="finalwebpvc_Customer_Payment_Report" %>
       ...
       <div class="content">
            <div class="container">
                <div class="row" style="">
                    ...
                    <div class="panel panel-default">
                    <!-- Default panel contents -->
                    <div class="panel-heading text-center" style="font-size: 24px">Customers Payment</div>
